...
func main() {
	...
	// TODO: change cron file to cleanup bars too and then get these new files hosted on AWS Elastic Beanstalk
	...
	*/
	...
	// curl http://localhost:5000/changeAtPartyStatus -d "partyID=10583166241324703384&facebookID=10155613117039816&atParty=true"
	go http.HandleFunc("/changeAtPartyStatus", changeAtPartyStatus)
	// curl http://localhost:5000/changeAtBarStatus -d "barID=1&facebookID=370&atBar=false&isMale=true&name=Steve&rating=None&status=Maybe&timeLastRated=2017-03-04T00:00:00Z"
	// curl http://localhost:5000/changeAtBarStatus -d "barID=1&facebookID=010101&atBar=true&isMale=true&name=Gerrard%20Holler&rating=None&status=Maybe&timeLastRated=2000-01-01T00:00:00Z"
	...
	*/
	...
	// curl http://localhost:5000/createBar -d "barKey=Q4T4r9JFzhNARPIe&facebookID=09876&isMale=false&nameOfCreator=Susan%20Ellmaurer&addressLine1=100%20N%20Los%20Angeles%20Rd&attendeesMapCleanUpHourInZulu=20&city=Los%20Angeles&country=United%20States&details=A%20bar%20for%20moms.&latitude=18&longitude=-129&name=Women&phoneNumber=608-114-2323&stateProvinceRegion=California&timeZone=6&zipCode=99031&Mon=4PM-2AM,1:45AM&Tue=4PM-2AM,1:45AM&Wed=4PM-2AM,1:45AM&Thu=2PM-2:30AM,2:00AM&Fri=10AM-3AM,2:30AM&Sat=8AM-3AM,2:30AM&Sun=8AM-1AM,12:45AM"
